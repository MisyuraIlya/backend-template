...
import { GetUsersService } from 'src/modules/cron/fetchers/GetUsers';
import { GetAgentService } from 'src/modules/cron/fetchers/GetAgents';
import { GetCategoriesService } from 'src/modules/cron/fetchers/GetCategories';
import { GetProductsService } from 'src/modules/cron/fetchers/GetProducts';
import { GetPriceListsService } from 'src/modules/cron/fetchers/GetPriceList';
import { GetPriceListDetailedService } from 'src/modules/cron/fetchers/GetPriceListDetailed';
import { GetPriceListUserService } from 'src/modules/cron/fetchers/GetPriceListUser';
import { GetAttributesMainService } from 'src/modules/cron/fetchers/GetAttributesMain';
import { GetAttributesSubService } from 'src/modules/cron/fetchers/GetAttributesSub';
import { GetAttributeProducts } from 'src/modules/cron/fetchers/GetAttributeProducts';
import { InitializationService } from 'src/modules/cron/fetchers/Initialization';
import { Admin } from 'src/common/decorators/roles.decorator';
import { RolesGuard } from '../auth/guards/roles.guard';
import { GetVarietiesService } from 'src/modules/cron/fetchers/GetVarieties';
